  ...
  static QUIC_STATUS QUIC_API stream_cb(HQUIC,void*ctx,QUIC_STREAM_EVENT*e){
    ...
    try {
      ...
      case QUIC_STREAM_EVENT_RECEIVE:{
        ...
        if(total>receive_limit||e->RECEIVE.BufferCount>64||a.borrowed.load()+total>receive_limit){
        ...
        a.borrowed+=total;peak(a.max_borrowed,a.borrowed.load());++a.pending_receives;
